...
data modify entity @e[type=armor_stand,tag=teplus.update_life_plus,distance=..1,limit=1] HandItems[0] set from entity @s Inventory[{Slot:102b}]

data remove entity @e[type=armor_stand,tag=teplus.update_life_plus,distance=..1,limit=1] HandItems[0].tag.AttributeModifiers

item replace entity @s armor.chest from entity @e[type=armor_stand,tag=teplus.update_life_plus,distance=..1,limit=1] weapon.mainhand
