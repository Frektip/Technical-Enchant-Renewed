...
data modify entity @e[type=armor_stand,tag=teplus.update_armored,distance=..1,limit=1] HandItems[0] set from entity @s SelectedItem

data remove entity @e[type=armor_stand,tag=teplus.update_armored,distance=..1,limit=1] HandItems[0].tag.AttributeModifiers

item replace entity @s weapon.mainhand from entity @e[type=armor_stand,tag=teplus.update_armored,distance=..1,limit=1] weapon.mainhand
