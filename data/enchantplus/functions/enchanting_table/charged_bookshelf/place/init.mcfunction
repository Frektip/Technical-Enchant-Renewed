...
execute at @s anchored eyes positioned ^ ^ ^ run function enchantplus:enchanting_table/charged_bookshelf/place/raycast

#This Iris marker is where we placed the block (in theory) 
execute as @e[type=marker,tag=teplus.ray] at @s run function enchantplus:enchanting_table/charged_bookshelf/place/set_bookshelf
