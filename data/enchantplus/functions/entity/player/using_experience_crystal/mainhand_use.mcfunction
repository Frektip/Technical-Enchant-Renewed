...
execute store result score @s teplus.xpcrtl run data get entity @s SelectedItem.tag.Content.Value[0]
execute store result score #temp.max teplus.xpcrtl run data get entity @s SelectedItem.tag.Content.Value[1]
execute store result score #temp.tier teplus.xpcrtl run data get entity @s SelectedItem.tag.Content.Tier
...
execute if score @s teplus.xpcrtl matches 0.. run item modify entity @s weapon.mainhand enchantplus:experience_crystal_update
