...
tag @s add teplus.light_source.south
...
execute as @e[type=item_display,tag=teplus.visual_bookshelf,tag=teplus.lgt.this,distance=..10] run function enchantplus:entity/marker/light/update_display/south
