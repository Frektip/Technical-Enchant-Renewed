...
execute as @s[tag=!tier.up] positioned ~ ~1 ~ if entity @e[type=marker,tag=teplus.enchanting_table,sort=nearest,tag=teplus.tier3,distance=...5] run function enchantplus:entity/armor_stand/table_rotate/tier_up

#Not has 18 charged bookshelves
execute as @s[tag=tier.up] positioned ~ ~1 ~ if entity @e[type=marker,tag=teplus.enchanting_table,sort=nearest,tag=!teplus.tier3,distance=...5] run function enchantplus:entity/armor_stand/table_rotate/tier_down
