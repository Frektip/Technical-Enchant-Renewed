...
execute store result score #teplus.attib.amnt teplus.data run data get entity @s HandItems[0].tag.AttributeModifiers[{AttributeName:"minecraft:generic.attack_damage"}].Amount
#Scale it by 10
