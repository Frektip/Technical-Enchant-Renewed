...
execute if data storage teplus:heldench Mainhand.tag.Enchantments[{id:"minecraft:frost_walker",lvl:2s}] run tag @s add teplus.heldench_error
...
execute if entity @s[tag=teplus.heldench] unless data storage teplus:heldench Mainhand.tag.Enchantments[{id:"minecraft:frost_walker",lvl:2s}] run data modify storage teplus:heldench Mainhand.tag.Enchantments append value {id:"minecraft:frost_walker",lvl:2s}
