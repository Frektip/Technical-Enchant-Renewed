...
execute if data storage teplus:heldench Mainhand.tag.CustomCurse.Slippery run tag @s add teplus.heldench_error
...
execute if entity @s[tag=teplus.heldench] unless data storage teplus:heldench Mainhand.tag.CustomCurse.Slippery run data modify storage teplus:heldench Mainhand.tag.CustomCurse.Slippery set value 1
