...
execute if data storage teplus:heldench Mainhand.tag.CustomCurse.Fragile run tag @s add teplus.heldench_error
...
execute if entity @s[tag=teplus.heldench] unless data storage teplus:heldench Mainhand.tag.CustomCurse.Fragile run data modify storage teplus:heldench Mainhand.tag.CustomCurse.Fragile set value 1
