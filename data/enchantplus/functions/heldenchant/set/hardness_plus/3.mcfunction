...
execute if data storage teplus:heldench Mainhand.tag.CustomEnchantments[{id:"HardnessPlus",lvl:3}] run tag @s add teplus.heldench_error
...
execute if entity @s[tag=teplus.heldench] run data remove storage teplus:heldench Mainhand.tag.CustomEnchantments[{id:"HardnessPlus"}]

#3.- Check if the item doesn't have this enchantment previously
execute if entity @s[tag=teplus.heldench] unless data storage teplus:heldench Mainhand.tag.CustomEnchantments[{id:"HardnessPlus",lvl:3}] run data modify storage teplus:heldench Mainhand.tag.CustomEnchantments append value {id:"HardnessPlus",lvl:3}
...
execute if data storage teplus:heldench Mainhand.tag.CustomEnchantments[{id:"HardnessPlus",lvl:3}] as @e[type=armor_stand,tag=teplus.held_ench,distance=..1,limit=1] run item modify entity @s weapon.mainhand enchantplus:set_attributes/heldenchant/shield_ench
