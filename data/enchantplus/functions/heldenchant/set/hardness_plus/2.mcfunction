...
execute if data storage teplus:heldench Mainhand.tag.CustomEnchantments[{id:"HardnessPlus",lvl:2}] run tag @s add teplus.heldench_error
...
execute if entity @s[tag=teplus.heldench] unless data storage teplus:heldench Mainhand.tag.CustomEnchantments[{id:"HardnessPlus",lvl:2}] run data modify storage teplus:heldench Mainhand.tag.CustomEnchantments append value {id:"HardnessPlus",lvl:2}
...
execute if data storage teplus:heldench Mainhand.tag.CustomEnchantments[{id:"HardnessPlus",lvl:2}] as @e[type=armor_stand,tag=teplus.held_ench,distance=..1,limit=1] run item modify entity @s weapon.mainhand enchantplus:set_attributes/heldenchant/shield_ench
