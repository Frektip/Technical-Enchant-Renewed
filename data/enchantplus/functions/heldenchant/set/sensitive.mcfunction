...
execute if data storage teplus:heldench Mainhand.tag.CustomCurse.Sensitive run tag @s add teplus.heldench_error
...
execute if entity @s[tag=teplus.heldench] unless data storage teplus:heldench Mainhand.tag.CustomCurse.Sensitive run data modify storage teplus:heldench Mainhand.tag.CustomCurse.Sensitive set value 1
