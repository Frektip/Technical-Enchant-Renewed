...
execute unless score .maxdmg tep.rc matches 0 if score .tempdmg tep.rc < .maxdmg tep.rc run item modify entity @s armor.head enchantplus:copy_damage

#If the Damage score exceeds the max score, clear the item
# Do it for certain custom enchantments
execute unless score .maxdmg tep.rc matches 0 if score .tempdmg tep.rc >= .maxdmg tep.rc run item replace entity @s armor.head with air
