...
data modify storage teplus:item_dura item set from entity @s Inventory[{Slot:100b}]
...
execute if score .tempdmg tep.rc < .maxdmg tep.rc run item modify entity @s armor.feet enchantplus:copy_nbt