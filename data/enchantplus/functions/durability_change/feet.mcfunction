...
execute if score .tempdmg tep.rc < .maxdmg tep.rc run item modify entity @s armor.feet enchantplus:copy_damage

#If the Damage score exceeds the max score, clear the item
# Do it for certain custom enchantments
execute if score .tempdmg tep.rc >= .maxdmg tep.rc run item replace entity @s armor.feet with air
