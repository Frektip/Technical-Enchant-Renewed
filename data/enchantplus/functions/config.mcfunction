...
tellraw @s {"text":"\n"}
tellraw @s ["",{"text":"[\u25b6\u25b6]","bold":true,"color":"#409F57","clickEvent":{"action":"run_command","value":"/function teplus_exten:manager/menu"},"hoverEvent":{"action":"show_text","contents":"Clic here to go"}},{"translate":" Extensions Manager:","color":"#74E18E"},{"translate":" Change the behaviour of extra features from the datapack adjusting to your needs.","color":"gray"}]
tellraw @s {"text":"\n"}
