###Debug Message###
tellraw @a[tag=teplus.pydbgm] ["",{"text":"TE+» ","color":"#65DAD4","bold":true},{"text":"(Chopping): ","color":"#7BA991","italic":true,"bold":false},{"text":"Mined in North - South direction","color":"gray","italic":true,"bold":false}]
