...
execute as @e[tag=Tri.poi1] at @s run function enchantplus:result/poison_aspect/trident/hit1
execute as @e[tag=Tri.poi2] at @s run function enchantplus:result/poison_aspect/trident/hit2
execute as @e[tag=Tri.poi3] at @s run function enchantplus:result/poison_aspect/trident/hit3
