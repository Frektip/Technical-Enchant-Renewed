###Debug Message###
tellraw @a[tag=teplus.pydbgm] ["",{"text":"TE+» ","color":"#65DAD4","bold":true},{"text":"(Mining+): ","color":"#7F9DA5","italic":true,"bold":false},{"text":"Mined in Up - Down direction","color":"gray","italic":true,"bold":false}]
