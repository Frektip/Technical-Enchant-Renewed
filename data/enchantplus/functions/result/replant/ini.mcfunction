...
execute as @e[type=item,distance=..7,nbt={Age:0s,Item:{id:"minecraft:torchflower_seeds"}}] at @s run function enchantplus:result/replant/torchflower
execute as @e[type=item,distance=..7,nbt={Age:0s,Item:{id:"minecraft:pitcher_pod"}}] at @s run function enchantplus:result/replant/pitcher_plant