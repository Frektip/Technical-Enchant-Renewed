###Debug Message###
tellraw @a[tag=teplus.pydbgm] ["",{"text":"TE+» ","color":"#65DAD4","bold":true},{"text":"(Exavator): ","color":"#9B6446","italic":true,"bold":false},{"text":"Mined in East - West direction","color":"gray","italic":true,"bold":false}]
