...
function enchantplus:loot/set_lore/set_enchantment_name
...
execute if score @s teplus.cencnt matches 1.. run function enchantplus:loot/set_lore/create_new_lore