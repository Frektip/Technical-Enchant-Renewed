...
tag @s add teplus.loot_chestplate
...
#Set new attributes (Life+)
execute if data entity @s Item.tag.CustomEnchantments[{id:"LifePlus"}] run item modify entity @s container.0 enchantplus:set_attributes/loot/life_plus
