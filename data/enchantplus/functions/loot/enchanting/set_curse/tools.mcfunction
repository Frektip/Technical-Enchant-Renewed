...
execute if score $out random matches 2 unless entity @s[nbt={Item:{tag:{CustomCurse:{Exhaustion:1}}}}] run data modify entity @s Item.tag.CustomCurse.Exhaustion set value 1
