...
execute if score @s TADBX.Page matches 2.. if score @s TADBX.Page >= $page.lim TADBX.data if score $extra.pg TADBX.data matches 1.. run function teplus_admin_box:enchant_menu/helper/add_blank_spaces
...
execute if score @s TADBX.Page matches 2.. if score @s TADBX.Page >= $page.lim TADBX.data run data modify block ~ ~ ~ Items append from storage teplus:admin_box Profile.NavEnd[]