...
execute if data storage teplus:updates {TAM:{Inputs:{Section2:{components:{"minecraft:custom_data":{teplus:{id:"xp_crystal"}}}}}}} run return run function teplus:anvil/merge/interaction/item_type/experience_crystal/update_tier
