...
execute store result score #book_vanilla teplus.anvil.value run function teplus:anvil/merge/interaction/checks/book_have_vanilla {slot:2}
execute if score #book_vanilla teplus.anvil.value matches 0 store result score #book_vanilla teplus.anvil.value run function teplus:anvil/merge/interaction/checks/book_have_vanilla {slot:6}
