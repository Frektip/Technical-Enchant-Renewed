#execute if entity @s[tag=teplus.anvil.HasCombined] run function technical_anvil:menu/update_ui/output_slot
...
execute if data entity @s Items[{Slot:2b}].id run scoreboard players set @s teplus.anvil.value 0