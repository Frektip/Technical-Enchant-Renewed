...
execute if score #mrgbk teplus.game_opts matches 0 if data entity @s Items[{Slot:2b}].components.minecraft:stored_enchantments if data entity @s Items[{Slot:6b}].components.minecraft:stored_enchantments run function teplus:anvil/merge/menu/change_item/inputs/has_valid_inputs
...
execute if score #itwbk teplus.game_opts matches 0 if data storage teplus:updates TAM.Inputs.Section1.teplus.valid if data storage teplus:updates {TAM:{Inputs:{Section2:{id:"minecraft:enchanted_book"}}}} run function teplus:anvil/merge/menu/change_item/inputs/has_valid_inputs
...
execute if score #mrgit teplus.game_opts matches 0 if entity @s[tag=teplus.anvil.IsSameItem] if data storage teplus:updates TAM.Inputs.Section1.teplus.valid if data storage teplus:updates TAM.Inputs.Section2.teplus.valid run function teplus:anvil/merge/menu/change_item/inputs/has_valid_inputs
