...
execute as @a[distance=..10] if score #teplus.anvil.this_interaction_id teplus.player.id = @s teplus.player.id at @s run function teplus:utils/spawn_loot with storage teplus:updates ChangedItems[0]
