# This function updates input related Slots wether there's an item in any input slot (10b or 16b) or not
# @params
# - {slot}: the slot to update (11, 12, 14, 15)
...
$data modify storage teplus:updates TAE.CurrentUI[{Slot:$(slot)b}] set from entity @s Items[{Slot:$(slot)b}]