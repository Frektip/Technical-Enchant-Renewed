...
function teplus:anvil/extract/menu/change_item/inputs/has_valid_inputs
...
function teplus:anvil/extract/interaction/checks/get_enchantments {enchant:0,curse:1}
...
# If it fails it means that there are ONLY vanilla/TE+ custom enchantments on the item
execute unless data storage teplus:updates TAE.Output.Result.components.minecraft:stored_enchantments run function teplus:anvil/extract/interaction/create_item/failed {err:"no_book"}