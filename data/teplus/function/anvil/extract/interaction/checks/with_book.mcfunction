...
function teplus:anvil/extract/interaction/checks/get_enchantments {enchant:1,curse:0}
...
execute unless data storage teplus:updates TAE.Output.Result.components.minecraft:stored_enchantments run function teplus:anvil/extract/interaction/create_item/failed {err:"no_isolated_core"}