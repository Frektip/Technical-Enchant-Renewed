...
# Small chance to get an Experience Crystal
execute if predicate teplus:random_chance/15 at @e[type=marker,tag=teplus.enchanting_table,tag=teplus.tier5,distance=..1] positioned ~ ~1 ~ run function teplus:enchant/give_xp_crystal/main