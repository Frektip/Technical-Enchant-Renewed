...
execute if entity @s[tag=teplus.loot_is_item] run function #teplus:enchanting/items/set_curse
...
execute if entity @s[tag=teplus.loot_is_book] run function teplus:enchant/set_curse/success

#Loop until the Copy Storage is empy
data remove storage teplus:loot Copy[0]
execute if data storage teplus:loot Copy[0] run function teplus:enchant/set_curse/loop_build