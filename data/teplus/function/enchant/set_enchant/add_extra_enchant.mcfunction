...
execute if score #teplus.rarity teplus.data matches 3 unless score #size teplus.data matches 3 run function teplus:enchant/set_enchant/core
execute if score #teplus.rarity teplus.data matches 2 unless score #size teplus.data matches 2 run function teplus:enchant/set_enchant/core