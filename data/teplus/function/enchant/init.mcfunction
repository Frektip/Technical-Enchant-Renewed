...
execute if predicate teplus:item/no_enchants if entity @s[nbt={Item:{id:"minecraft:book"}}] if entity @e[type=marker,tag=teplus.enchanting_table,distance=..1] run return run say normal book without echantments
