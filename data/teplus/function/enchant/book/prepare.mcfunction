...
execute at @e[type=marker,tag=teplus.enchanting_table,tag=!teplus.is_enchanting,distance=..1] run summon item_frame ~ ~ ~ {Silent:1b,Facing:1b,Invulnerable:1b,Fixed:1b,Tags:["teplus.enchanted"],Item:{id:"minecraft:enchanted_book",count:1}}
