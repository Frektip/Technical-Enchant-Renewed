execute if data storage teplus:loot Temp[0] run tellraw @a[tag=teplus.debug_mode] [{"text":"TE+» ","color":"#65DAD4","bold":true},{"text":"(Enchanting★★★): ","color":"#24E3F9","italic":true,"bold":false},{"text":"Selected enchantment is ","color":"gray","italic":true,"bold":false},{"nbt":"Temp[0].id","storage":"teplus:loot","color":"#bb864d","italic":true,"bold":false}, {"text":" with levels ","color":"gray","italic":true,"bold":false},{"nbt":"Temp[0].lvl","storage":"teplus:loot","color":"green","italic":true,"bold":false}]

execute if data storage teplus:chest Temp[0] run tellraw @a[tag=teplus.debug_mode] [{"text":"TE+» ","color":"#65DAD4","bold":true},{"text":"(Chest loot): ","color":"#24E3F9","italic":true,"bold":false},{"text":"Selected enchantment is ","color":"gray","italic":true,"bold":false},{"nbt":"Temp[0].id","storage":"teplus:chest","color":"#bb864d","italic":true,"bold":false}, {"text":" with levels ","color":"gray","italic":true,"bold":false},{"nbt":"Temp[0].lvl","storage":"teplus:chest","color":"green","italic":true,"bold":false}]
