...
summon armor_stand ~.5 ~-1.1 ~.5 {Invulnerable:1b,Marker:1b,Invisible:1b,NoGravity:1b,NoBasePlate:1b,Tags:["teplus.armor_stand","teplus.bookshelf_level","teplus.level1"],Pose:{Head:[0f,90f,0f]},DisabledSlots:4144959}
