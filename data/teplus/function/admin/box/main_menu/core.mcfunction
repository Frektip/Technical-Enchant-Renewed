...
execute if score $ui_changed teplus.admin_box.value matches 1.. run function teplus:admin/box/refresh_ui/init {menu:"Main"}
#=============================================================================================#



#====================================== ADMIN BOX ACTIONS ======================================#
# Player clics on the Items Button item
