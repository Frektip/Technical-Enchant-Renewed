...
execute if score $teplus.match_struct teplus.data matches 0 run function teplus:chests/create_loot/system/success


data remove storage teplus:chest Struct.With[0]
execute if score $teplus.match_struct teplus.data matches 1 if data storage teplus:chest Struct.With[0] run function teplus:chests/create_loot/system/get_from_structure
