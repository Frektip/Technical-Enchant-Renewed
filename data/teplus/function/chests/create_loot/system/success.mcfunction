...
execute unless score #current_max teplus.data matches ..1 run function teplus:chests/create_loot/system/set_level
...
# In case there this enchantment has more odds to appear in this structure chest, then repeat this function
execute if score #chest.odds teplus.data matches 1.. run scoreboard players remove #chest.odds teplus.data 1
execute unless score #chest.odds teplus.data matches ..0 run function teplus:chests/create_loot/system/success