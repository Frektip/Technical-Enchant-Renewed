...
# --------------- First Row --------------- #
# Slot 0 : Blank
function teplus:core/ui/set_blank {slot:0,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 1 : Blank
function teplus:core/ui/set_blank {slot:1,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 3 : Blank
function teplus:core/ui/set_blank {slot:3,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 4 : Toggle
...
# Slot 5 : Blank
function teplus:core/ui/set_blank {slot:5,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 7 : Blank
function teplus:core/ui/set_blank {slot:7,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 8 : Blank
function teplus:core/ui/set_blank {slot:8,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# --------------- Second Row --------------- #
# Slot 9 : Blank
function teplus:core/ui/set_blank {slot:9,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 10 : Blank
function teplus:core/ui/set_blank {slot:10,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
...
# Slot 12 : Blank
function teplus:core/ui/set_blank {slot:12,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 13 : Action
...
# Slot 14 : Blank
function teplus:core/ui/set_blank {slot:14,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 15 : Progress/Vertical
data modify storage teplus:ui Global[{profile:"technical_anvil"}].Merge append value {id:"minecraft:red_stained_glass_pane",count:1,components:{"minecraft:tooltip_display":{hide_tooltip:true},"minecraft:bundle_contents":[{id:"minecraft:stick",count:64}],"minecraft:custom_data":{teplus:{ui:1b}},"minecraft:custom_model_data":{strings:["teplus:progress.empty.vertical"]}},Slot:15b}
# Slot 16 : Blank
function teplus:core/ui/set_blank {slot:16,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 17 : Blank
function teplus:core/ui/set_blank {slot:17,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# --------------- Third Row --------------- #
# Slot 18 : Blank
function teplus:core/ui/set_blank {slot:18,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 19 : Blank
function teplus:core/ui/set_blank {slot:19,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
...
# Slot 25 : Blank
function teplus:core/ui/set_blank {slot:25,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:blank_slot"]}}
# Slot 26 : Merge Frame + Blank
function teplus:core/ui/set_blank {slot:26,profile:"technical_anvil",type:"Merge",cmd:{strings:["teplus:technical_anvil.merge_frame"]}}