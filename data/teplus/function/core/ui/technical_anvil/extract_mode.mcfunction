...
# --------------- First Row --------------- #
# Slot 0 : Blank
function teplus:core/ui/set_blank {slot:0,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 1 : Blank
function teplus:core/ui/set_blank {slot:1,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 2 : Blank
function teplus:core/ui/set_blank {slot:2,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 3 : Blank
function teplus:core/ui/set_blank {slot:3,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 4 : Toggle
...
# Slot 5 : Blank
function teplus:core/ui/set_blank {slot:5,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 6 : Blank
function teplus:core/ui/set_blank {slot:6,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 7 : Blank
function teplus:core/ui/set_blank {slot:7,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 8 : Blank
function teplus:core/ui/set_blank {slot:8,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# --------------- Second Row --------------- #
# Slot 9 : Blank
function teplus:core/ui/set_blank {slot:9,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
...
# Slot 17 : Blank
function teplus:core/ui/set_blank {slot:17,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# --------------- Third Row --------------- #
# Slot 18 : Blank
function teplus:core/ui/set_blank {slot:18,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 19 : Blank
function teplus:core/ui/set_blank {slot:19,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 20 : Blank
function teplus:core/ui/set_blank {slot:20,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 21 : Blank
function teplus:core/ui/set_blank {slot:21,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 22 : Action
...
# Slot 23 : Blank
function teplus:core/ui/set_blank {slot:23,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 24 : Blank
function teplus:core/ui/set_blank {slot:24,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 25 : Blank
function teplus:core/ui/set_blank {slot:25,mode:"Extract" ,cmd:{strings:["teplus:blank_slot"]}}
# Slot 26 : Extract Frame + Blank
function teplus:core/ui/set_blank {slot:26,mode:"Extract" ,cmd:{strings:["teplus:technical_anvil.extract_frame"]}}