...
tag @s add ComError
#-------------EXCLUSIVE FOR BOOTS-------------#
execute if score #aglt Enchopts matches 0 if data storage teplus:tech_anvil.ui CurrentItems[{Slot:6b}].tag.CustomEnchantments[{id:"Agility"}] run function technical_anvil:interaction/merge/item_with_book/agility
