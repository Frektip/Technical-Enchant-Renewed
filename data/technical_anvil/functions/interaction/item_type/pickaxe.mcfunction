...
execute if score #mnpl Enchopts matches 0 if data storage teplus:tech_anvil.ui CurrentItems[{Slot:6b}].tag.StoredCustomEnchantments[{id:"MiningPlus"}] unless data storage teplus:tech_anvil.ui ResultItem.tag.CustomEnchantments[{id:"VeinMiner"}] run function technical_anvil:interaction/merge/item_with_book/mining_plus
execute if score #vnmr Enchopts matches 0 if data storage teplus:tech_anvil.ui CurrentItems[{Slot:6b}].tag.StoredCustomEnchantments[{id:"VeinMiner"}] unless data storage teplus:tech_anvil.ui ResultItem.tag.CustomEnchantments[{id:"MiningPlus"}] run function technical_anvil:interaction/merge/item_with_book/vein_miner
