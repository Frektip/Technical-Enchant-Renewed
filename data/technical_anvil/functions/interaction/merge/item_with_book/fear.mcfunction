...
execute unless data storage teplus:tech_anvil.ui ResultItem.tag.CustomCurse.Fear run data modify storage teplus:tech_anvil.ui ResultItem.tag.CustomCurse.Fear set value 1
