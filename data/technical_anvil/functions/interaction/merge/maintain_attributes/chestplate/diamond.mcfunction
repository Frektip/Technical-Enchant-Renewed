##Change or not Armor or Armor Thoughness attributes
...
##Replace Armor or Armor tougness attributes if the input item has
...
##Remove Armor or Armor Toughness from storage
