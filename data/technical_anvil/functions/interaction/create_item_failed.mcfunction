...
data modify entity @s Items prepend value {Slot: 22b, id: "structure_void", Count:1b, tag: {Teplus:{ui:1b},CustomModelData:70139, display: {Lore:['{"translate":"You cannot add that enchantment","color":"gray","italic":false}','{"translate":"to that item!","color":"gray","italic":false}'],Name: '{"translate":"Error!","color":"red","italic":false}'}}}
