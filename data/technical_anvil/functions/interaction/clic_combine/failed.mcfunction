...
execute if entity @s[tag=!No.xpcomb] run tellraw @p ["",{"translate":"You don't have at least ","color":"red"},{"score":{"name":"@s","objective":"TCHA.cost"},"color":"dark_red"},{"translate":" Experience Levels!","color":"red"}]
