...
summon armor_stand ~.2 ~.2 ~.5 {Tags:["teplus.technical_anvil_decorative","teplus.technical_anvil_init"],DisabledSlots:4144959,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:anvil",Count:1b}],Small:1b,Marker:1b} 
