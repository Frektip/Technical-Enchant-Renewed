...
summon armor_stand ~.5 ~.2 ~.2 {Tags:["teplus.technical_anvil_decorative","teplus.technical_anvil_init"],DisabledSlots:4144959,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:anvil",Count:1b}],Small:1b,Marker:1b,Pose:{Head:[0f,90f,0f]}} 
