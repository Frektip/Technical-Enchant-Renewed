...
data remove storage teplus:tech_anvil.ui ChangedItems[0].Slot
...
data modify entity @e[type=item,tag=tcha.return,distance=..50,limit=1] Item set from storage teplus:tech_anvil.ui ChangedItems[0]