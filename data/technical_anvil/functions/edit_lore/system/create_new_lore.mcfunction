...
function technical_anvil:edit_lore/system/set_enchantment_name
...
execute if score @s teplus.cencnt matches 1.. run function technical_anvil:edit_lore/system/create_new_lore