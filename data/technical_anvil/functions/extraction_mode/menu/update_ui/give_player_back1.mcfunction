...
data remove storage teplus:tech_extract ChangedItems[1].Slot
...
data modify entity @e[type=item,tag=tcha.return1,distance=..50,limit=1] Item set from storage teplus:tech_extract ChangedItems[1]