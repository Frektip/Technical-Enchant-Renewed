...
data modify entity @s Items prepend value {Slot: 13b, id: "structure_void", Count:1b, tag: {Teplus:{ui:1b}, display: {Lore:['{"text":"You need to place normal books in the other slot!","color":"gray","italic":false}'],Name: '{"text":"Error!","color":"red","italic":false}'}}}
