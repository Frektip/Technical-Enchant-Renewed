...
execute if score #mnpl Enchopts matches 0 if score $out random matches 3 unless data storage tepspw:ench {CustomEnchantments:[{id:"MiningPlus"}]} run data modify storage tepspw:ench CustomEnchantments append value {id:"MiningPlus",lvl:1}
execute if score #vnmr Enchopts matches 0 if score $out random matches 4 unless data storage tepspw:ench {CustomEnchantments:[{id:"VeinMiner"}]} run data modify storage tepspw:ench CustomEnchantments append value {id:"VeinMiner",lvl:1}
