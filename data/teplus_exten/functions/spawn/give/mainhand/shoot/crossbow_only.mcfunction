item replace entity @s weapon.mainhand with minecraft:crossbow{Enchantments:[{}]}
...
execute unless data entity @s HandItems[1].tag.CustomEnchantments run item replace entity @s weapon.offhand with minecraft:air