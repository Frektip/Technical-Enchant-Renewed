...
data modify storage teplus:item_lore TempEnch append from entity @s HandItems[1].tag.CustomEnchantments[]
...
function teplus_exten:spawn/give/offhand/set_lore/new_lore
