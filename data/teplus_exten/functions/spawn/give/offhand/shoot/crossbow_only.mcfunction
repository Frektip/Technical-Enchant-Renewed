item replace entity @s weapon.offhand with crossbow{Enchantments:[{}]}
...
execute unless data entity @s HandItems[0].tag.CustomEnchantments run item replace entity @s weapon.mainhand with air