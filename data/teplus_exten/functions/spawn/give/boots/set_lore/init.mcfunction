...
data modify storage teplus:item_lore TempEnch append from entity @s ArmorItems[0].tag.CustomEnchantments[]
...
function teplus_exten:spawn/give/boots/set_lore/new_lore
