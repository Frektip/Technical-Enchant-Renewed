...
function teplus_exten:spawn/give/boots/set_lore/apply
...
execute if score @s teplus.cencnt matches 1.. run function teplus_exten:spawn/give/boots/set_lore/new_lore
