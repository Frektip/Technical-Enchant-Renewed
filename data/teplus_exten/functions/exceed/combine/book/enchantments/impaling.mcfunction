...
execute store result score @s TCHA.Section1 run data get storage teplus:tech_anvil.ui CurrentItems[{Slot:2b}].tag.StoredEnchantments[{id:"minecraft:impaling"}].lvl
...
execute unless data storage teplus:tech_anvil.ui ResultItem.tag.StoredEnchantments[{id:"minecraft:impaling"}] run data modify storage teplus:tech_anvil.ui ResultItem.tag.StoredEnchantments append value {id:"minecraft:impaling",lvl:1s}
...
execute store result storage teplus:tech_anvil.ui ResultItem.tag.StoredEnchantments[{id:"minecraft:impaling"}].lvl short 1 run scoreboard players get @s TCHA.Section1
tag @s add VEPApply
