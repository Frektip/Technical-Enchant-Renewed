...
tellraw @s ["",{"translate":"- Open the Menu for:   ","color":"white"},{"text":"[","color":"#E35443"},{"translate":"Advanced Enchanters","color":"#CF4D3D","hoverEvent":{"action":"show_text","contents":[{"text":"Clic here to go"}]},"clickEvent":{"action":"run_command","value":"/function teplus_exten:manager/menu/villagers/menu"}},{"text":"]","color":"#E35443"}]
