...
summon armor_stand ~.5 ~ ~.5 {NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Invisible:1b,Tags:["teplus.loot_gen","tepxc.strong","tepxc.average","tepxc.low","tepxc.burried_treasure"],DisabledSlots:4144959,HandItems:[{id:"minecraft:enchanted_book",Count:1b},{}]}
