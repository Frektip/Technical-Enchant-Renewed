...
execute at @e[type=minecraft:marker,tag=iris.ray] as @e[type=minecraft:chest_minecart,limit=1,sort=nearest] run function teplus_exten:chests/insert_book/abandoned_mineshaft
