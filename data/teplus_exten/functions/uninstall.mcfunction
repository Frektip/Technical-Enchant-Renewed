...
schedule clear teplus_exten:villagers/main
...
scoreboard objectives remove tepxv.limit

team remove tepdrp.strong
team remove tepdrp.average
team remove tepdrp.low
team remove tepdrp.curses
team remove teplus.adenh